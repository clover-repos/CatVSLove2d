...
pl.ani = {} --The plays sub-table for animations.
...
function pl.InviColl()
    pl.coll:setPreSolve(
            function(collider_1, collider_2, contact)
                ...
                elseif collider_1.collision_class == "pl" and collider_2.collision_class == "ene" then
                    local px, py = collider_1:getPosition()
                    local tx, ty = collider_2:getPosition()
...
function pl.load()
    ...
    treeI = love.graphics.newImage("res/extra/tree1.png")
